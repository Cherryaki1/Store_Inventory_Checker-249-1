...
public class Assignment0 {
    public static void main(String[] args) {
        ...
        final String password = "249"; // The password is initialized as a String as a password can be anything
                                       // including numbers

        int selection; // Variable determining the selection from the selection menu
        int attempts = 0; // This variable tracks the total number of attempts made (Terminate program at
                          // 12 attempts)

        do { // We create a do while loop so that the selection menu is prompted at least
             // once to the user.
            ...
            switch (selection) {
                ...
                case 1:
                    ...
                    int tempAttempts = 0; // A temporary attempt amount tracker for each itteration (Back to menu after
                                          // reaching 3)
                    do {
                        ...
                        if (inputedPassword.equals(password)) // VALID PASSWORD: Option 1 executes
                        {
                            ...
                            if ((Book.findNumberOfCreatedBooks() + addAmount) <= maxBooks) {
                                for (int i = 0; i < addAmount; i++) // This loop prompts the user to input the book's
                                                                    // information (itterates as many times as the
                                                                    // amount of books he wanted to add)
                                {
                                    ...
                                    System.out.println(""); // Blank line between book entries (less cluttered
                                                            // interface)
                                }
                            }

                            else {
                                System.out.println("Sorry, the remaining amount of books you can add is "
                    ...
                    // In the case the user failed to enter the password 12 times TOTAL, the code
                    // will let the user know the program will shutdown:
                    if (attempts == 12) {
                        System.out.println("Program detected suspicious activities and will terminate immediately!");
                        System.exit(0);
                    }
                    System.out.println(""); // Blank line between last password attempt & the menu reapearing (less
                                            // cluttered interface)
                    selection = 0; // Before breaking out of the loop, we have to reset selection to an int outside
                                   // of the while loop range to make the menu reapear
                    break;
                ...
                case 2:
                    ...
                    do {
                        ...
                        if (inputedPassword.equals(password)) // VALID PASSWORD: Option 2 executes
                        {
                            ...
                            int choice = 1; // By default, this do while loop will continue iterating if the user doesnt
                                            // change it's value inside the loop
                                            // Hency why by selecting option 1 in the inner loop, the user willingly
                                            // opts to reitterate this loop asking for a book to update
                            do {
                                ...
                                if (inventory[bookModify] == null) {
                                    System.out.println(
                                            "There is no book at the provided index. Please select one of the following:");

                                    boolean loop = true; // If the user inputs anything besides 1 or 2, they will
                                                         // constantly loop inside this section
                                    do {
                                        System.out.println(
                                                "1. Re-enter another book to modify\n2. Return to the main menu");
                                        System.out.print("Please enter your choice > ");
                                        choice = sc.nextInt();
                                        System.out.println(""); // Add Blank Line
                                        if (choice == 1) {
                                            loop = false; // By chosing 1, the user breaks out of this boolean loop and
                                                          // is prompted to enter a new book index
                                        } else if (choice == 2) {
                                            break; // By chosing 2, the user will break out of the entire loop bringing
                                                   // them back to the main menu
                                        } else {
                                            System.out.println(
                                                    "Your input does not match one of the selections. Please try again.");
                                            continue;
                                        }
                                    } while (loop == true);
                                } else {
                                    ...
                                    do {
                                        ...
                                        System.out.println(
                                                "Here is the current information of the book you have selected:\n"
                                        ...
                                        switch (modSelection) {
                                            case 1:
                                                sc.nextLine(); // Garbage collector to clear the previous nextInt()
                                                               // value
                ...
                case 5:
                    // ------
                    System.out.println(
                            "Thank you for using the Book Store Inventory Checker. The system will now shutdown!");
                    System.exit(0);
